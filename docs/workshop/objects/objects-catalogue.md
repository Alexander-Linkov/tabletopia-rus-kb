...
Также количество объектов играет важную роль, при использоовании случаных элементов, подробнее читайте в статье [Рандомайзеры: Колоды, Мешки, и случайные элементы](http://help.tabletopia.com/knowledge-base/randomizers/).
...
Если в текущей группе находятся объекты одного типа и размера, появляется возможность добавить случайный элемент. Подробнее читайте в статье [Рандомайзеры: Колоды, Мешки, и Случайные элементы](http://help.tabletopia.com/knowledge-base/randomizers/).
