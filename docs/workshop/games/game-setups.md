...
* Добавьте **[нестандартные звуки](../enhance/custom-sounds.md)** вашим игровым объектам.
* Разместите **[музыкальный проигрыватель](../objects/music-box.md)** в игровой стол. Он будет играть указанную музыку в течении игры.
